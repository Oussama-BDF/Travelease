...
<div class="col-md-6 col-lg-4 mb-4">
    <div class="trip-card card rounded shadow">
        ...
        <a href="{{ route('admin.trips.show', $trip->uuid) }}" class="stretched-link"></a>
        <div class="card-body">
            ...
            <div class="text-center">
                <p class="small text-uppercase mb-1">{{ Str::limit($trip->description, 25) ?? "There Is No Description!"}}</p>
            </div>
        ...
        <div class="card-footer text-muted d-flex justify-content-around" style="z-index: 1000;">
            <a class="btn btn-danger call-delete-modal" data-action="{{route('admin.trips.destroy', $trip->uuid)}}"  href="#" data-toggle="modal" data-target="#delete-modal-alert">Delete</a>
            <a href="{{route('admin.trips.edit', $trip->uuid)}}" class="btn btn-secondary">Edit</a>
        </div>
    </div>
</div>